...
def trace_mcp_call(tool_name: str, params: dict = None, result: str = None, error: str = None):
...
def trace_parse(operation: str, input_size: int = None, output_count: int = None, details: str = None):
